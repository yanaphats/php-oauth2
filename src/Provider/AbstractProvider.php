...
use Sandbox\OAuth2\Grant\AbstractGrant;
use Sandbox\OAuth2\Grant\GrantFactory;
use Sandbox\OAuth2\OptionProvider\OptionProviderInterface;
use Sandbox\OAuth2\OptionProvider\PostAuthOptionProvider;
use Sandbox\OAuth2\Provider\Exception\IdentityProviderException;
use Sandbox\OAuth2\Token\AccessToken;
use Sandbox\OAuth2\Token\AccessTokenInterface;
use Sandbox\OAuth2\Tool\ArrayAccessorTrait;
use Sandbox\OAuth2\Tool\GuardedPropertyTrait;
use Sandbox\OAuth2\Tool\QueryBuilderTrait;
use Sandbox\OAuth2\Tool\RequestFactory;
